...
\DoxyCodeLine{Throughput:\ 21.06\ Mb/s}
\DoxyCodeLine{Bandwidth\ Utilization:\ 100.42\%}
\DoxyCodeLine{Time:\ \ 2.26}

\end{DoxyCode}

\item Enhanced UDP Sender (Juno 2)\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{Throughput:\ 9.14\ Mb/s}
\DoxyCodeLine{Bandwidth\ Utilization:\ 43.57\%}
\DoxyCodeLine{Transfer:\ \ 5.22}
...
\item Based on the fact that our enhanced protocol is taking on 43.\+57\% and with the above considered we believe that our protocol receives around \texorpdfstring{$\sim$}{\string~}50\% of the throughput. 
