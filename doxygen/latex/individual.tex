...
\DoxyCodeLine{Sent\ 2109\ sequence}
\DoxyCodeLine{ACK\ received\ for\ closing\ packet\ sequence\ number:\ 2109}
\DoxyCodeLine{Throughput:\ 17.66\ Mb/s}
\DoxyCodeLine{Bandwidth\ Utilization:\ 84.20\%}
\DoxyCodeLine{Time:\ \ 9.55}

\end{DoxyCode}

\item Receiver (Europa)\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{Last\ packet\ received.\ Sequence\ Number:\ 2109}
\DoxyCodeLine{Sent\ final\ ack\ for\ sequence\ number:\ 2109}
...
\begin{DoxyItemize}
\item The resulting bandwidth of 84.\+20\% meets the minimum requirement of 70\% with no artificial packet loss or reordering.
