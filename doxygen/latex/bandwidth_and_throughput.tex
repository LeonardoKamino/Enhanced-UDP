\doxysection{Bandwidth \& Throughput Calculations}
...
\hypertarget{bandwidth_and_throughput_b_and_t1}{}\doxysubsection{\texorpdfstring{1.\+0 Throughput For A Single Instance of A Protocol}{1.\+0 Throughput For A Single Instance of A Protocol}}\label{bandwidth_and_throughput_b_and_t1}
\hypertarget{bandwidth_and_throughput_throughput_1}{}\doxysubsubsection{\texorpdfstring{1.\+1 Throughput Calculation}{1.\+1 Throughput Calculation}}\label{bandwidth_and_throughput_throughput_1}
...
\end{DoxyItemize}\hypertarget{bandwidth_and_throughput_throughput_2}{}\doxysubsubsection{\texorpdfstring{1.\+2 Relevant Throughput Code}{1.\+2 Relevant Throughput Code}}\label{bandwidth_and_throughput_throughput_2}
...
\end{DoxyCode}
 \hypertarget{bandwidth_and_throughput_throughput_3}{}\doxysubsubsection{\texorpdfstring{1.\+3 Throughput Explanation}{1.\+3 Throughput Explanation}}\label{bandwidth_and_throughput_throughput_3}
...
\end{DoxyEnumerate}\hypertarget{bandwidth_and_throughput_b_and_t2}{}\doxysubsection{\texorpdfstring{2.\+0 Bandwidth For A Single Instance of A Protocol}{2.\+0 Bandwidth For A Single Instance of A Protocol}}\label{bandwidth_and_throughput_b_and_t2}
\hypertarget{bandwidth_and_throughput_bandwidth_1}{}\doxysubsubsection{\texorpdfstring{2.\+1 Bandwidth Calculation}{2.\+1 Bandwidth Calculation}}\label{bandwidth_and_throughput_bandwidth_1}
...
\end{DoxyItemize}\hypertarget{bandwidth_and_throughput_bandwidth_2}{}\doxysubsubsection{\texorpdfstring{2.\+2 Relevant Bandwidth Code}{2.\+2 Relevant Bandwidth Code}}\label{bandwidth_and_throughput_bandwidth_2}
...
\DoxyCodeLine{\textcolor{keywordtype}{double}\ duration\ =\ (end.tv\_sec\ -\/\ start.tv\_sec)\ +\ (end.tv\_usec\ -\/\ start.tv\_usec)\ /\ 1000000.0;}
\DoxyCodeLine{\textcolor{keywordtype}{double}\ throughput\ =\ ((totalBytesSent\ +\ \textcolor{keyword}{sizeof}(\mbox{\hyperlink{struct_packet_header}{PacketHeader}})\ *\ sequenceNumber)\ *\ 8)\ /\ duration;}
\DoxyCodeLine{\textcolor{keywordtype}{double}\ bandwidthUtilization\ =\ \ (throughput\ /\ \mbox{\hyperlink{sender_8c_a54619b1687e9899d304d27f631f956ce}{LINK\_CAPACITY}})\ *\ 100;\ \ }
\DoxyCodeLine{printf(\textcolor{stringliteral}{"{}Throughput:\ \%.2f\ Mb/s\(\backslash\)n"{}},\ throughput/1000000.0);}
...
\end{DoxyCode}
 \hypertarget{bandwidth_and_throughput_bandwidth_3}{}\doxysubsubsection{\texorpdfstring{2.\+3 Throughput Explanation}{2.\+3 Throughput Explanation}}\label{bandwidth_and_throughput_bandwidth_3}
